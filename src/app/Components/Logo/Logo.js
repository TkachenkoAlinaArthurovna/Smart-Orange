export default function Logo({ fill, width = "50px", height = "50px" }) {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      />
      <circle style={{ fill: fill }} cx="128.4" cy="191.9" r="31.9" />
      <path
        style={{ fill: fill }}
      ...
      />
      <circle style={{ fill: fill }} cx="384.4" cy="191.9" r="31.9" />
      <path
        style={{ fill: fill }}
